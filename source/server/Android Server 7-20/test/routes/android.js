...
function getNearbyRestaurant(req, res) {
    ...
    var check = 'SELECT * FROM restaurant WHERE province in (SELECT provinceid FROM provinces WHERE province = ?)';
    ...
    pool.query(check, check_Params, function (err, rows, fields) {
        ...
        pool.query(userAddSql, userAddSql_Params, function (err, result) {
            ...
            pool.query(provinceSql, provinceSql_Params, function (err, rows, field) {
                ...
                var provinceAddSql_Params = [provinceid, id];
...
function login(req, res) {
    ...
    var post = ['user_all', uname, upwd, 1];
...
function getInfo(req, res) {
    ...
    var check = 'SELECT * FROM user WHERE id in (select id from user_all where username = "zxcv" and identity = 1)';
    var post = [name, 1];
